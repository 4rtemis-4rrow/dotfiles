...
git clone https://github.com/zpm-zsh/colorize.git ~/.oh-my-zsh/custom/plugins/colorize/
git clone https://github.com/Sam-programs/zsh-calc ~/.oh-my-zsh/custom/plugins/zsh-calc/
